...
a.showTransition?(i.append("path").attr("d",h.outerRadius(g)).areaStyle(function(a){return a.data.areaStyle}).transition().duration(a.transition.duration).delay(function(b,c){return c*a.transition.delay}).attr("d",h.outerRadius(f)),i.append("text").text(function(b){return a.format(b.value)}).attr("transform","scale(0)").style("text-anchor","middle").fontStyle(b.fontStyle).transition().duration(a.transition.duration).delay(function(b,c){return c*a.transition.delay}).ease(a.transition.ease).attr("transform",function(a){return"translate("+h.centroid(a)+") scale(1)"})):(i.append("path").attr("d",h).areaStyle(function(a){return a.data.areaStyle}),i.append("text").text(function(b){return a.format(b.value)}).attr("transform",function(a){return"translate("+h.centroid(a)+")"}).fontStyle(b.fontStyle).style("text-anchor","middle"))})},c}(b);a.PieChart=j}(dChart||(dChart={}));